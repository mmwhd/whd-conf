...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>WHD</b></span>
			...
			<a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button"><span class="sr-only">切换导航</span></a>
          	<div class="navbar-custom-menu">
				<ul class="nav navbar-nav">
					...
					<#-- env -->
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">当前环境：${CONF_CURRENT_ENV.title}(${CONF_CURRENT_ENV.env}) <span class="caret"></span></a>
                    ...
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
							欢迎 ${Request["CONF_LOGIN_IDENTITY"].username}
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#if Request["CONF_LOGIN_IDENTITY"].permission == 1>
...
<#macro commonFooter >
	<footer class="main-footer">
		Powered by <b>WHD-CONF</b> 1.0.0
		<div class="pull-right hidden-xs">
			<strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
                <a href="" target="_blank" >hayden</a>
                &nbsp;
                <a href="https://github.com/mmwhd/whd-conf" target="_blank" >github</a>
