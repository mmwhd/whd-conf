	...
	<div class="content-wrapper">
		...
		<section class="content">
			<div class="callout callout-info">
				...
				<br>
				<p>
                    <a target="_blank" href="https://github.com/mmwhd/whd-conf">Github</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<iframe src="" frameborder="0" scrolling="0" width="170px" height="20px" style="margin-bottom:-5px;"></iframe>
					<br><br>
