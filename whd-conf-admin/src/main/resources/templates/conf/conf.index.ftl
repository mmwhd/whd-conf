...
<body class="hold-transition skin-blue sidebar-mini <#if cookieMap?exists && cookieMap["adminlte_settings"]?exists && "off" == cookieMap["adminlte_settings"].value >sidebar-collapse</#if> ">
	         	...
	         	<div class="modal-body">
					<form class="form-horizontal form" role="form" >
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
								<input type="text" class="form-control" name="env" value="${CONF_CURRENT_ENV.env}" readonly >
							</div>
                        </div>
						<div class="form-group">
	...
	<script>
		...
		<#if Request["CONF_LOGIN_IDENTITY"].permission == 1>
        	hasPermission = true;
		<#else>
			<#if Request["CONF_LOGIN_IDENTITY"].permissionProjects?exists >
				<#list Request["CONF_LOGIN_IDENTITY"].permissionProjects?split(",") as appname >
