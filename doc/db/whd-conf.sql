CREATE database if NOT EXISTS `whd-conf` default character set utf8 collate utf8_general_ci;
use `whd-conf`;


CREATE TABLE `whd_conf_env` (
...
CREATE TABLE `whd_conf_node_log` (
...
INSERT INTO `whd_conf_env` VALUES ('test', '测试环境', '1');
INSERT INTO `whd_conf_node` VALUES ('test', 'default.key01', 'default', '测试配置01', '1'), ('test', 'default.key02', 'default', '测试配置02', '2'), ('test', 'default.key03', 'default', '测试配置03', '3');
INSERT INTO `whd_conf_project` VALUES ('default', '示例项目');
INSERT INTO `whd_conf_user` VALUES ('admin', 'e10adc3949ba59abbe56e057f20f883e', '1', null), ('user', 'e10adc3949ba59abbe56e057f20f883e', '0', 'default');
